                        ...
                        >
                            ...
                            >
                                ...
                                <div class="relative group h-full">
                                    <div
                                        @click="prev"
                                        class="absolute opacity-0 z-30 group-hover:opacity-100 text-gray-100 cursor-pointer flex items-center w-12 h-full left-0 bg-black/5"
                                    >
                                        <ChevronLeftIcon class="w-12" />
                                    </div>
                                    <div
                                        @click="next"
                                        class="absolute opacity-0 z-30 group-hover:opacity-100 text-gray-100 cursor-pointer flex items-center w-12 h-full right-0 bg-black/5"
                                    >
